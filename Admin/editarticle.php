...
.ob {
 ...
 <div class="wrapper">
     <div class="registration_form">
         ...
         <form action="../funphp/action.php" method="post" enctype="multipart/form-data">
             ...
             <div class="form_wrap">
                 ...
                 <div class="input_wrap">
                     ...
                     <input type="text" name="link" placeholder="Type link" value="<?php echo $link; ?>">
                 </div>
                 <div class="input_wrap">
                 ...
                 <div class="photo">
                     ...
                     <img src="../iblog/artphotos/<?php echo $photos; ?>" width="120" class="img-thumbnail">
                 </div>
